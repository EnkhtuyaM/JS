...
const employeeslist = () => {
  employees.map((employee) => {
    ...
    employeeName.innerText = "Name:" + employee.name;
    position.innerText = "Position:" + employee.position;
    salary.innerText = "Salary:" + employee.salary;
    department.innerText = "Department:" + employee.department;
